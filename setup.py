...
setup(
    ...
    # above.
    author_email='victoria.ruiz.serra@gmail.com',  # Optional

    # This should be a valid link to your project's main homepage.
    #
    # This field corresponds to the "Home-Page" metadata field:
    url="https://github.com/vicruiser/3dnet",  # Optional
    ...
    long_description=long_description,  #long_description,  # Optional
    ...
    keywords=["communities","CLI", "protein structure", "PDB", 'networks'],  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/vicruiser/3dnet/issues',
        # 'Funding': 'https://donate.pypi.org',
        # 'Say Thanks!': 'http://saythanks.io/to/example',
        'Source': 'https://github.com/vicruiser/3dnet/',
    },
